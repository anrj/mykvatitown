"""
Leader Server — SIMULATION.

Launched by `python launch.py --sim --task leader`
"""
...
def reset():
    ...
    if wheels:
        wheels.change_scene(GODOT_SCENES.get('leader', 'res://scenes/maps/lane_follower.tscn'))
...
def main():
    ...
    ap = argparse.ArgumentParser(description='Leader Server — Simulation')
    ...
    suppress_http_logs()
    print('=' * 60)
    print('LEADER SERVER — SIMULATION')
    print('=' * 60)
